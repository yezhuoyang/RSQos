...
def generate_example_ppt10_on_10_qubit_device_different_shots():
    ...
    proc2 = process(processID=2, start_time=0, vdataspace=vdata2, vsyndromespace=vsyn2, shots=2000)
    ...
    proc3 = process(processID=3, start_time=0, vdataspace=vdata3, vsyndromespace=vsyn3, shots=3000)
